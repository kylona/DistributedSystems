ruleset manage_sensors {
  meta {
    ...
    shares sensorChildren, sensors, temperatures, passQuery, subscribed
  }
  ...
  rule record_tx {
    ...
    pre {
      ...
      isNewSensor = event:attrs{"isNewSensor"} == true
			...
			absolutePath = "file:///Users/kylestorey/workspace/distributedSystems/DistributedSystems/subscriptions_lab/"
